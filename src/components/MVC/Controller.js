...
class Controller extends View{
	...
	rulsButtonHandler(e){
		...
		var mes_of_ruls1 = "Расставьте корабли и нажмите кнопку 'ИГРАТЬ'. ",
				mes_of_ruls2 = "Когда попадете по кораблю соперника - стреляйте еще раз, если мимо - стреляет соперник. ",
		...
		this.uf.closeMessage(mes_of_ruls1, mes_of_ruls2, mes_of_ruls3, mes_of_ruls4, mes_of_ruls5);
